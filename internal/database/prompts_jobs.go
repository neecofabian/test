...
func (s *promptStore) EnqueueQueryTriggerJobs(ctx context.Context) ([]*TriggerJob, error) {
...
func (s *promptStore) UpdateTriggerJobWithResults(ctx context.Context, triggerJobID int32, queryString string, results string) error {
...
func (s *promptStore) DeleteOldTriggerJobs(ctx context.Context, retentionInDays int) error {
...
func (s *promptStore) ListQueryTriggerJobs(ctx context.Context, opts ListTriggerJobsOpts) ([]*TriggerJob, error) {
	q := sqlf.Sprintf(
...
func (s *promptStore) CountQueryTriggerJobs(ctx context.Context, queryID int64) (int32, error) {
	q := sqlf.Sprintf(
